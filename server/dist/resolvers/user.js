...
const UserDetailsInput_1 = require("./UserDetailsInput");
...
let UserResolver = class UserResolver {
    ...
    updateUserDetails(options, { req }) {
        return __awaiter(this, void 0, void 0, function* () {
            const errors = ValidateUserDetails_1.validateUserDetails(options);
            if (errors) {
                return { errors };
            }
            let user;
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], UserResolver.prototype, "updateUserDetails", null);
