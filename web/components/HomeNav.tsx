...
export const HomeNav: React.FC<HomeNavProps> = ({ }) => {
    ...
    return (
        <Container>
            <Option
                style={{ borderBottom: underlineFirst }}
                onClick={handleFirst}
            >DISCOVER</Option>
            <Option
                style={{ borderBottom: underlineSecond }}
                onClick={handleSecond}
            >KEYBOARD</Option>
            <Option
                style={{ borderBottom: underlineThird }}
                onClick={handleThird}
            >KEYCAPS</Option>
            <Option
                onClick={handleIV}
                style={{ borderBottom: underlineIV }}
            >SWITCHES</Option>
            <Option
                style={{ borderBottom: underlineV }}
                onClick={handleV}
            >CUSTOM</Option>
        </Container>
    );
